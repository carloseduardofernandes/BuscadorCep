...
{
    /// <summary>
    /// Futuramente implementar por CSV, pois em testes com grandes volumes se mostrou muito rápido
    /// </summary>
    public class ExportadorEnderecoCepCSV : IExportadorEnderecoCep
    {
        ...
        public ExportadorEnderecoCepCSV(string outputFile)
        {
